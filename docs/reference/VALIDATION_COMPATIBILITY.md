...
DataK9 supports **36 validation types** that work with both **file sources** (CSV, Excel, JSON, Parquet) and **database sources** (PostgreSQL, MySQL, SQL Server, Oracle, SQLite).
