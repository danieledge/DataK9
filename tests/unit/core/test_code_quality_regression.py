...
Test Dataset: /home/user/www/test-data/titanic.csv
...
# Test configuration
TITANIC_PATH = Path("/home/user/www/test-data/titanic.csv")
BASELINE_DIR = Path("/home/user/www/dqa/wip/deleteme/baselines")
OUTPUT_DIR = Path("/home/user/www/dqa/wip/deleteme/regression_output")
